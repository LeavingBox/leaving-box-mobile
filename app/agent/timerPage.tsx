...
export default function TimerPage() {
  ...
  const [maxHintsForDifficulty, setMaxHintsForDifficulty] = useState<
    number | null
  >(null);
  const [lastHintCostSeconds, setLastHintCostSeconds] = useState<number | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    const handleExtraHintGranted = (data: ExtraHintGrantedPayload) => {
      setExtraHintsUsed(data.extraHintsUsed);
