...
- Écoutes :
  - `gameStarted` (si rôle agent : affiche log; si rôle opérateur : logique distincte décrite dans doc operator)
  - `sessionCleared` → alerte + retour.
- Actions : bouton "Quitter" déconnecte (si rôle operator) ou `router.back()` sinon.
